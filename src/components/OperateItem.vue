<template>
  <!-- operate item -->
  <el-form class="connection-form" size="mini" @submit.native.prevent>
    <el-form-item>
      <el-row :gutter="6">
        <!-- db index select -->
        <!-- <el-col :span="12">
  ...
  methods: {
    ...
    changeDb(dbIndex = false) {
      ...
      .then(() => {
        ...
        this.searchMatch = '';
        this.$parent.$parent.$parent.$refs.databaseList.refreshDatabaseList();
    ...
    addNewKey() {
      ...
      var connect = dbClient.createConnection(configCopy.host, configCopy.port, configCopy.username, configCopy.auth, this.newKeyName)
    ...
    changeMatchMode() {
      ...
      this.$parent.$parent.$parent.$refs.databaseList.refreshDatabaseList(this.searchMatch, this.searchExact);
    },
