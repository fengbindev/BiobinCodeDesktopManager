    ...
    <el-form label-position="top" size="mini">
      ...
      <el-card class="setting-card">
        ...
        <div class="current-version">
          ...
          <a href="https://github.com/fengbindev/BiobinCodeDesktopManager">{{ $t('message.manual_update') }}</a>
          <a href="https://github.com/fengbindev/BiobinCodeDesktopManager">{{ $t('message.project_home') }}</a>
        </div>
      </el-card>
    </el-form>
